...
class NewItemDialog(wx.Dialog):
    """新增 Item 時呼叫的 客製化 Dialog"""
    def __init__(self, parent, defaultValue=""):
        wx.Dialog.__init__(self, parent, wx.ID_ANY, "新增物件", size=(420, 220), pos=(500,300))
        self.parent = parent
...
if __name__ == "__main__":
    ...
    app = wx.App()
    dlg = NewItemDialog(parent = None)
    ret = dlg.ShowModal()
    if ret == wx.ID_OK:
        print(dlg.newItemName, dlg.newItemType, ret)